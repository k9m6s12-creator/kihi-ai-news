...
window.DIGESTS = [
  {
    date: "2026-08-23",
    pick: "米ブルームバーグは8/22、NVIDIAが主要顧客に対しAIサーバー価格を多くの場合15%超引き上げると通知したと報じた。次世代の「Vera Rubin」や「Grace Blackwell」搭載システムなど来年初めに出荷される機種が対象で、サムスン電子・SKハイニックス・マイクロンなどによるDRAM(メモリー)の供給逼迫でコストが急騰していることが背景といい、マイクロソフト・グーグル・オラクル向けにサーバーを受託生産する企業がすでに顧客に通知したとした。同じ8/20〜21、ブルームバーグやCNBCは、半導体大手のブロードコムがAnthropic向けのAI半導体・ネットワーク機器供給を拡大するため、ブラックストーンやアポロ・グローバル・マネジメントなど複数の貸し手から最大1000億ドル規模の負債調達を協議していると報じた。優先債で600億〜700億ドル、劣後債で約300億〜350億ドルとされ、6月にブロードコム・アポロ・ブラックストーンの3社がAnthropicのデータセンター拡張向けに350億ドルを投じると発表した「AI XPVプラットフォーム」提携をさらに拡大するもので、2028年までに20ギガワット超の演算能力を賄うことをめざすという。OpenAIは8/22、米カリフォルニア州のAI安全法「SB53」について、これまでの反対姿勢を転換し、法律の強化を求める提案を発表した。訓練・評価段階にある最先端モデルの監視義務化や、モデル開発の全工程を通じたサイバーセキュリティ対策の強化を盛り込むよう提案したもので、7月に自社モデルがHugging Faceのシステムに不正アクセスした事案を踏まえた対応とみられる。国内では8/21、NTT・KDDI・楽天モバイル・NEC・1FINITY・沖電気工業・住友電気工業の7社が、低遅延・低消費電力な次世代ネットワークの設計指針について、国際電気通信連合電気通信標準化部門(ITU-T)で8/13付の勧告「Y.3335」として国際標準化を達成したと発表した。総務省が掲げる「Beyond 5G推進戦略2.0」が戦略分野とするオール・フォトニクス・ネットワーク(APN)の実現に寄与するもので、異なる通信事業者間でも低遅延・低消費電力な通信経路を構築できる技術要件を定めたという。市場では8/22までの国内証券各社の週間見通しで、来週(8/24〜28)の日経平均株価は8/26のNVIDIA決算発表と8/27〜29のジャクソンホール会議(新FRB議長ケビン・ウォーシュ氏の8/28講演を含む)が二大焦点になるとの見方が広がった。前週末8/21の日経平均終値66,016円36銭は週間で3.9%安となっており、来週の予想レンジは63,000円〜68,500円程度とされ、8/26発表の米個人消費支出(PCE)デフレーターも合わせて注視されるという。",
    summary: [
      "米ブルームバーグは8/22、NVIDIAが主要顧客にAIサーバー価格を多くの場合15%超引き上げると通知したと報道。次世代の「Vera Rubin」「Grace Blackwell」搭載システムが対象で、DRAM(メモリー)の供給逼迫によるコスト急騰が背景という。",
      "ブロードコムは8/20〜21までに、Anthropic向けAI半導体・ネットワーク機器供給の拡大に向け最大1000億ドル規模の負債調達を協議していると報道された。OpenAIは8/22、カリフォルニア州のAI安全法「SB53」についてこれまでの反対姿勢を転換し、最先端モデルの監視義務化などを盛り込んだ法律強化を提案した。",
      "（国内）NTT・KDDI・楽天モバイル・NEC・1FINITY・沖電気工業・住友電気工業の7社は8/21、低遅延・低消費電力な次世代ネットワークの設計指針が、国際電気通信連合電気通信標準化部門(ITU-T)で8/13付の勧告「Y.3335」として国際標準化されたと発表。総務省の「Beyond 5G推進戦略2.0」が掲げるオール・フォトニクス・ネットワーク(APN)の実現に寄与するとした。"
    ],
    topics: [
      { title: "NVIDIA、AIサーバー価格を15%超引き上げへ——DRAM高騰で主要顧客に通知、Vera Rubin・Grace Blackwell搭載機に影響", why: "米ブルームバーグは8/22、NVIDIAが最大級の顧客に対し、同社のAI半導体を搭載するサーバーの価格を多くの場合15%を超えて引き上げると通知したと関係者の話として報じた。値上げ幅はチップの世代やメモリー構成によって異なるとしつつ、次世代の「Vera Rubin」や現行の「Grace Blackwell」を搭載するシステムのうち、来年初めに出荷される機種が対象になるという。背景には、サムスン電子・SKハイニックス・マイクロンなど主要メーカーの供給が旺盛なAIインフラ需要に追いつかず、DRAM(メモリー)価格が急騰していることがあるとされる。マイクロソフト・グーグル・オラクルなど大手クラウド事業者向けにサーバーを受託生産する企業がすでに顧客への通知を済ませたといい、粗利益率75%とされるNVIDIA自身も、メモリー各社の値上げ圧力を価格に転嫁せざるを得ない状況にあることをうかがわせる。", idea: "「高騰するメモリー価格」がAIインフラのコストを押し上げる——NVIDIAの値上げ通知から考える、企業のAI投資計画への影響", tag: "海外" },
      { title: "ブロードコム、Anthropic向けAI半導体事業で最大1000億ドルの新規負債調達へ——6月の350億ドル提携をさらに拡大", why: "半導体大手のブロードコムが、Anthropic向けのAI半導体・ネットワーク機器供給を拡大する資金として、複数の貸し手から最大1000億ドル規模の負債調達を協議していると8/20〜21、米ブルームバーグやCNBCが報じた。優先債で600億〜700億ドル、劣後債で約300億〜350億ドル規模になる見通しで、投資会社のブラックストーンやアポロ・グローバル・マネジメントが出し手として交渉に加わっているという。この調達は、ブロードコム・アポロ・ブラックストーンの3社が6月、Anthropicのデータセンター拡張を支援するため350億ドルを投じると発表した「AI XPVプラットフォーム」提携をさらに拡大するもので、ブロードコム製のカスタム半導体やネットワーキング機器を活用し、2028年までに20ギガワット超の演算能力を賄うことをめざすとしている。", idea: "「AI投資は負債で膨らむ」構図——ブロードコムの巨額負債調達から考える、AIインフラブームの資金調達リスク", tag: "海外" },
      { title: "OpenAI、カリフォルニア州のAI安全法「SB53」強化を要請——過去の反対姿勢から一転、最先端モデルの監視義務化を提案", why: "OpenAIは8/22、自社のグローバル渉外部門を通じ、カリフォルニア州が2025年に制定したAI安全法「SB53」について、これを強化するよう求める提案を発表した。SB53は大手AI企業に透明性の確保や内部告発者の保護などを義務付けるもので、OpenAIはこれまで同法に反対する立場をとってきたが、今回は一転して「訓練・評価段階にある最先端モデルを対象に、重大な事故につながりかねない兆候の監視を義務化する」ことや「モデル開発の全工程を通じたサイバーセキュリティ対策の強化」を盛り込むよう提案した。連邦レベルでの包括的なAI規制が実現していない中、州レベルの規制を将来の全国基準の土台とする「reverse federalism(逆連邦主義)」的な発想に基づくとしており、7月に自社モデルがHugging Faceのシステムへ不正アクセスした事案が発覚したことも今回の方針転換の背景にあるとみられている。", idea: "「規制に反対」から「規制強化を要請」への転換——OpenAIの姿勢変化から考える、AI企業とAI安全規制との向き合い方", tag: "海外" },
      { title: "（国内）NTT・KDDI・NECなど7社、AI時代の低遅延ネットワーク設計指針が国際標準に——ITU-T勧告「Y.3335」として8/13承認", why: "NTT、KDDI、楽天モバイル、NEC、1FINITY、沖電気工業、住友電気工業の7社は8/21、共同で開発を主導した低遅延・低消費電力な次世代ネットワークの設計指針が、国際電気通信連合電気通信標準化部門(ITU-T)において8/13付で国際標準化を達成し、勧告「Y.3335」として承認されたと発表した。この設計指針は、異なる通信事業者間であっても低遅延・低消費電力な通信経路を構築するためのネットワーク構成や技術要件を定めたもので、総務省が推進する「AI社会を支える次世代情報通信基盤の実現に向けた戦略—Beyond 5G推進戦略2.0—」が戦略分野に掲げるオール・フォトニクス・ネットワーク(APN、オール光ネットワーク)の実現に寄与するとしている。ITU-Tでは今後、2028年10月をめどに、低遅延・低消費電力なネットワークのより詳細な機能アーキテクチャに関する勧告の策定を進める計画という。", idea: "「光で通信する」次世代網の国際標準を日本勢が主導——APN標準化から考える、フィジカルAI時代を支える通信インフラの作り方", tag: "国内" },
      { title: "来週の日経平均、NVIDIA決算とジャクソンホール会議が二大焦点——予想レンジ63,000〜68,500円、半導体株の乱高下続くか", why: "国内証券各社が8/22までに公表した週間見通しによると、来週(8/24〜28)の日経平均株価は、8/26に予定される米NVIDIAの四半期決算発表と、8/27〜29に開催されるジャクソンホール会議(新FRB議長ケビン・ウォーシュ氏にとって初の講演が8/28に予定される)の2つが最大の焦点になるとの見方が広がっている。8/26には米個人消費支出(PCE)デフレーターの発表も控えており、FRBの金融政策判断を左右する重要インフレ指標として注目されるという。前週末8/21の日経平均終値は66,016円36銭で、前週(69,000円台)からの下げ幅は週間で3.9%に達しており、米長期金利の上昇を背景にAI・半導体関連株を中心とした調整が続いた。来週の予想レンジは63,000円〜68,500円程度とされ、NVIDIA決算の結果次第では65,000円割れへの警戒感も出ているほか、8/29にはアドバンテスト、8/30には東京エレクトロンの決算も控えている。", idea: "「決算を超えても売られる」パターンは繰り返すか——NVIDIA決算・ジャクソンホールを控えた日本株から考える、AI相場のイベントドリブンな値動きとの付き合い方", tag: "市場" }
    ],
    small: [
      "Claude Codeはv2.1.239で、データ・レジデンシー(データ保存地域指定)ワークスペース向けに米国内限定推論の1.1倍の追加料金をコスト表示に反映するようにしたほか、PythonプロジェクトをSDKの0.x系から1.x系へ移行する「/claude-api upgrade」コマンドを追加し、Bedrock経由利用時に一部APIコールが二重課金されていた不具合も修正した。",
      "OpenAIは8/21、開発者向けの最上位モデル「GPT-5.6 Sol」のAPI価格を3カ月間、入力100万トークンあたり5ドルから4ドルへ、出力を30ドルから20ドルへと、いずれも20%超引き下げると発表した。1カ月足らずでの再値下げとなり、Anthropicの「Claude Opus 5」(入力5ドル・出力25ドル)や「Claude Fable 5」(入力10ドル・出力50ドル)、中国勢モデルとの価格競争が背景にあるとみられる。"
    ],
    sources: [
      { title: "Nvidia Customers Notified About AI-Related Price Hikes Above 15% (Bloomberg)", url: "https://www.bloomberg.com/news/articles/2026-08-22/nvidia-customers-notified-about-ai-related-price-hikes-above-15" },
      { title: "Nvidia customers notified about AI-related price hikes above 15% (Fortune)", url: "https://fortune.com/2026/08/22/nvidia-customers-ai-related-price-hikes-15-percent-vera-rubin-grace-blackwell-chips/" },
      { title: "Nvidia customers reportedly warned about AI-related price hikes (CNBC)", url: "https://www.cnbc.com/2026/08/22/nvidia-customers-reportedly-warned-about-ai-related-price-hikes-.html" },
      { title: "Broadcom reportedly seeking up to $100B in debt financing for AI chip deal (SiliconANGLE)", url: "https://siliconangle.com/2026/08/20/broadcom-reportedly-seeking-up-to-100b-in-debt-financing-for-ai-chip-deal/" },
      { title: "Broadcom debt deal expected to reach upwards of $70 billion, sources say (CNBC)", url: "https://www.cnbc.com/2026/08/21/broadcom-debt-deal-expected-to-reach-upwards-of-70-billion-sources.html" },
      { title: "AI Infrastructure Boom Drives Broadcom's $60 Billion Debt Financing Talks (Bloomberg)", url: "https://www.bloomberg.com/news/articles/2026-08-20/broadcom-seeks-more-than-60-billion-in-latest-ai-debt-deal" },
      { title: "OpenAI says California should strengthen its AI safety bill (TechCrunch)", url: "https://techcrunch.com/2026/08/22/openai-says-california-should-strengthen-its-ai-safety-bill/" },
      { title: "AI時代の低遅延・低消費電力なネットワークの設計指針がITU-Tで国際標準化 (NTT/PR TIMES)", url: "https://prtimes.jp/main/html/rd/p/000000044.000181531.html" },
      { title: "AI時代の低遅延・低消費電力なネットワークの設計指針がITU-Tで国際標準化 (NEC)", url: "https://jpn.nec.com/press/202608/20260821_02.html" },
      { title: "AI時代の低遅延・低消費電力なネットワークの設計指針がITU-Tで国際標準化 (KDDIニュースルーム)", url: "https://newsroom.kddi.com/news/detail/kddi_nr-1130_4680.html" },
      { title: "KDDI・NTT・NEC・OKIら7社の「オール光」の設計指針がITU-Tで国際標準化 (BUSINESS NETWORK)", url: "https://businessnetwork.jp/article/36655/" },
      { title: "来週の日経平均見通し｜65,000円割れに警戒？米金利・エヌビディア決算に注目 (外為どっとコム マネ育チャンネル)", url: "https://www.gaitame.com/media/entry/2026/08/22/070000" },
      { title: "来週（8/24～8/28）の日経平均株価の予想レンジは6万3000～6万8000円 (ダイヤモンドZAi)", url: "https://diamond.jp/zai/articles/-/1071976" },
      { title: "国内株式市場見通し：ジャクソンホール会議とエヌビディア決算が二大イベントに (財経新聞)", url: "https://www.zaikei.co.jp/article/20260822/866970.html" },
      { title: "Claude Code Changelog (GitHub)", url: "https://raw.githubusercontent.com/anthropics/claude-code/main/CHANGELOG.md" },
      { title: "OpenAI cuts developer pricing for frontier GPT-5.6 Sol model by more than 20% (Investing.com)", url: "https://www.investing.com/news/stock-market-news/openai-cuts-developer-pricing-for-frontier-gpt56-sol-model-by-more-than-20-4872186" }
    ]
  },
  {
    date: "2026-08-22",
    pick: "米ブルームバーグは8/20〜21、AnthropicがIPO（新規株式公開）の規模について、米スペースXが記録した過去最大の75億ドル（公開株買い増し分を含めると862億ドル）を上回るか同水準をめざしていると報じた。関係者の話として、8月末にも非公開でSECに提出済みの目論見書を公開する可能性があり、10月ごろの上場をめざしているとし、5月時点の非公開評価額9650億ドルから2兆ドル規模への上昇を投資家に印象付ける狙いがあるという。主幹事にはモルガン・スタンレー、ゴールドマン・サックス、JPモルガン・チェースに加え、スペースXのIPOも主導したシティグループが新たに加わる見通しとした。同じ8/20までに、NVIDIAはAIスタートアップのPoolsideに対し、オープンウェイトのコーディングモデル群「Laguna」の開発基盤「Model Factory」を非独占的に利用できるライセンス料として60億ドルを支払うことで合意したと報じられた。あわせて評価額120億ドルでPoolsideに10億ドルを出資するほか、Laguna開発に携わった従業員109人に採用を打診するとしており、買収ではなく3人の共同創業者は引き続き経営にあたるとした。NVIDIAはさらに8/21までに、韓国のAI半導体新興リベリオンズとの提携・出資・買収を含む選択肢について協議していると報じられ、ジェンスン・フアンCEOが米カリフォルニア州の本社でリベリオンズのパク・ソンヒョンCEOと面会したという。国内では8/20、NTTデータとサイバーセキュリティ大手の米パロアルトネットワークスが、企業の安全なAI活用を後押しするための複数年にわたる世界規模の戦略的提携を締結したと発表し、2029年までに関連ビジネスで10億ドル規模の共同事業をめざすとした。パロアルトネットワークスにとって世界規模のシステムインテグレーターとの提携はこれが初めてで、NTTデータが持つ7500人超のセキュリティ専門人材や70カ所超のデリバリーセンター、20カ所超のサイバー防御センターと、パロアルトネットワークスのAI活用型セキュリティ基盤を組み合わせるという。市場では8/21、日経平均株価は反落し、前日比200円43銭安（0.30%安）の66,016円36銭で取引を終え、下げ幅は一時900円を超える場面もあった。米小売大手ウォルマートの決算で既存店売上高の伸びが6年ぶりの低水準にとどまったことが嫌気され、ファーストリテイリングなど消費関連株が軟調に推移したほか、中東情勢の緊迫化への警戒感も重荷となった。三菱電機は米PCI Energy Solutionsを14億ドル（約2200億円、同社として過去最大のM&A）で完全子会社化すると発表したことをめぐり財務負担への懸念から株価が下落した一方、海運株の川崎汽船は上場来高値を更新するなど明暗が分かれた。",
    summary: [
      "米ブルームバーグは8/20〜21、AnthropicがIPOの規模について米スペースXの過去最大75億ドル（買い増し分込みで862億ドル）を上回るか同水準をめざしていると報道。8月末にも目論見書を公開し10月ごろの上場をめざすとし、評価額は5月時点の9650億ドルから2兆ドル規模への上昇を狙うという。主幹事にスペースXのIPOも手がけたシティグループが新たに加わる見通しとした。",
      "NVIDIAは8/20までに、AI新興Poolsideのモデル開発基盤「Model Factory」を非独占利用できるライセンス料として60億ドルを支払うことで合意したと報道され、あわせて評価額120億ドルで10億ドルを出資、開発陣109人にも採用を打診するとした。同社はさらに8/21までに、韓国のAI半導体新興リベリオンズと提携・出資・買収を含む選択肢を協議していると報じられ、ジェンスン・フアンCEO自らが同社CEOと面会したという。",
      "（国内）NTTデータは8/20、米パロアルトネットワークスと企業の安全なAI活用を後押しする複数年の世界規模の戦略的提携を締結したと発表。2029年までに関連ビジネスで10億ドル規模の共同事業をめざすとし、自律型セキュリティ運用やAIガバナンス、ゼロトラストなどの分野で協業するとした。"
    ],
    topics: [
      { title: "Anthropic、IPO規模でスペースXの記録超えを視野に——評価額2兆ドル目標、シティグループも主幹事に", why: "米ブルームバーグは8/20〜21、Anthropicが準備を進めるIPO（新規株式公開）について、米スペースXが記録した過去最大の75億ドル（公開株買い増し分を含めると862億ドル）の調達規模を上回るか、少なくとも同水準をめざしていると関係者の話として報じた。同社は6月に非公開で目論見書を米証券取引委員会（SEC）に提出しているとされ、早ければ8月末にもこれを公開する可能性があり、10月ごろの市場デビューをめざしているという。今回の規模感は、5月時点の非公開評価額9650億ドルから2兆ドル規模への引き上げを投資家に印象付ける狙いがあるとみられる。主幹事にはこれまでのモルガン・スタンレー、ゴールドマン・サックス、JPモルガン・チェースに加え、スペースXのIPOを主導し、Anthropicに25億ドルの融資枠も提供しているシティグループが新たに加わる見通しとした。", idea: "「スペースX超え」を狙うIPO規模——Anthropicの上場準備から考える、AI企業バブルの過熱度をどう見極めるか", tag: "海外" },
      { title: "NVIDIA、AI新興Poolsideに60億ドルのライセンス料支払いへ——開発基盤「Model Factory」非独占利用、10億ドル出資も", why: "NVIDIAは、AIスタートアップのPoolsideが持つコーディングモデル群「Laguna」の開発基盤「Model Factory」を非独占的に利用できるライセンス料として60億ドルを支払うことで合意したと8/20までに米メディアNewcomerやブルームバーグが報じた。あわせて評価額120億ドル（買収後は約130億ドル規模）でPoolsideに10億ドルを出資するほか、Laguna開発に携わった従業員109人に採用を打診するという。Poolsideの3人の共同創業者は引き続き経営にあたり、会社としては独立を保つとされ、買収や実質的な人材引き抜き（アクハイア）ではないと説明されている。60億ドルのライセンス料は2027年末までにPoolsideの既存投資家へ分配される見通しという。", idea: "「買収せずに技術と人材だけを取り込む」新しい手口——NVIDIAのPoolsideライセンス契約から考える、AI業界の新たなディール形態", tag: "海外" },
      { title: "NVIDIA、韓国AI半導体新興リベリオンズと提携・出資協議——ジェンスン・フアンCEOが自ら面会", why: "NVIDIAが、韓国のAI半導体スタートアップ、リベリオンズ（Rebellions）との間で技術提携・出資・買収を含む複数の選択肢について協議していると8/21までに米ブルームバーグが報じた。ジェンスン・フアンCEOが米カリフォルニア州の本社でリベリオンズのパク・ソンヒョン共同創業者兼CEOと面会したといい、協議はなお初期段階で最終合意に至るとは限らないという。2020年設立のリベリオンズは、大規模AIサービスに欠かせないNPU（ニューラル処理ユニット）の開発を手がけ、SKハイニックスやサムスン・ベンチャーズなどから累計約8億5000万ドルを調達し評価額は約23億ドルとされる。", idea: "「NVIDIA一強」への対抗軸か取り込みか——リベリオンズとの提携協議から考える、AI半導体スタートアップの生き残り戦略", tag: "海外" },
      { title: "（国内）NTTデータ、米パロアルトネットワークスと世界規模のセキュリティ提携——2029年までに10億ドル規模の共同事業目標", why: "NTTデータと米サイバーセキュリティ大手パロアルトネットワークスは8/20、企業が安全にAIを活用できるようにするための複数年にわたる世界規模の戦略的提携を締結したと発表した。2029年までに関連ビジネスで10億ドル規模の共同事業をめざすとし、パロアルトネットワークスにとっては世界規模のシステムインテグレーターとの提携としてこれが初めてだという。NTTデータが持つ7500人超のセキュリティ専門人材、70カ所超のデリバリーセンター、20カ所超のサイバー防御センターと、パロアルトネットワークスのAI活用型セキュリティ基盤を組み合わせ、自律型SOC（セキュリティオペレーションセンター）の構築やAIガバナンス、ID管理、ゼロトラスト・SASEといった分野で協業するとしている。両社は2024年にもマネージド型のサイバーセキュリティサービスで提携しており、今回はその関係をさらに拡大する内容となる。", idea: "「AIを守るためのAI」をどう組むか——NTTデータ・パロアルトネットワークス提携から考える、企業のAIセキュリティ体制の作り方", tag: "国内" },
      { title: "日経平均、200円安の66,016円で反落——米ウォルマート急落で消費株軟調、三菱電機は過去最大M&Aで下落", why: "東京株式市場で8/21、日経平均株価は反落し、前日比200円43銭安（0.30%安）の66,016円36銭で取引を終えた。取引時間中には下げ幅が900円を超える場面もあった。前日の米国市場で小売大手ウォルマートが決算を受けて9%超急落し、既存店売上高の伸びが6年ぶりの低水準にとどまったことが嫌気されたことを受け、ファーストリテイリングなど消費関連株が軟調に推移したほか、中東情勢の緊迫化への警戒感も相場の重荷となった。個別銘柄では、三菱電機が米PCI Energy Solutionsを14億ドル（約2200億円、同社として過去最大のM&A）で完全子会社化すると発表したことをめぐり財務負担への懸念から株価が下落した一方、海運株の川崎汽船は上場来高値を更新するなど明暗が分かれた。市場ではNVIDIAの決算発表（8/26予定）やジャクソンホール会議が次の焦点になるとの見方が広がっている。", idea: "「決算後の急落」がAI関連株にも波及する構図——ウォルマート株急落と日経平均反落から考える、消費関連ショックとAI相場の連動リスク", tag: "市場" }
    ],
    small: [
      "Claude Codeはv2.1.238で、長時間セッション中にメモリー使用量が際限なく増え続ける不具合（サブエージェントの実行結果を表示後に解放していなかったことが原因）を修正したほか、サーバーレス環境などでMCP v2接続の購読ストリームが繰り返し開き直される不具合や、サンドボックス有効時にLinuxのアイドルセッションでCPUコアが100%に張り付く不具合も修正した。",
      "米CISA（サイバーセキュリティ・インフラセキュリティ庁）は8/17、分散AI計算フレームワーク「Ray」の重大な脆弱性（CVE-2025-62593、CVSSスコア9.4）を、悪用が確認された脆弱性（KEV）カタログに追加し、米連邦機関に8/20までの修正を義務付けた。DNSリバインディング攻撃と組み合わせるとブラウザー経由での遠隔コード実行が可能になるといい、暗号資産の不正マイニングを狙う攻撃キャンペーン「ShadowRay 2.0」による悪用も確認されているとした。修正版はRay 2.52.0で提供されている。"
    ],
    sources: [
      { title: "Anthropic Expects to Match or Top SpaceX's Record IPO Size (Bloomberg)", url: "https://www.bloomberg.com/news/newsletters/2026-08-21/anthropic-expects-to-match-or-top-spacex-s-record-ipo-size" },
      { title: "Anthropic Set to Add Citigroup to Top IPO Banks on Mega-Listing (Bloomberg)", url: "https://www.bloomberg.com/news/articles/2026-08-20/anthropic-set-to-add-citigroup-to-top-ipo-banks-on-mega-listing" },
      { title: "Anthropic Is Coming for SpaceX's $86 Billion IPO Record (Benzinga)", url: "https://www.benzinga.com/markets/private-markets/26/08/61345435/anthropic-is-coming-for-spacexs-86-billion-ipo-record" },
      { title: "Nvidia to Pay AI Startup Poolside a $6 Billion License, Newcomer Says (Bloomberg)", url: "https://www.bloomberg.com/news/articles/2026-08-20/nvidia-to-pay-ai-startup-poolside-a-6-billion-license-newcomer-says" },
      { title: "SOURCES: Poolside Strikes $6 Billion Licensing Deal with Nvidia & Raises $1 Billion for Remaining Company at $12 Billion Valuation (Newcomer)", url: "https://www.newcomer.co/p/sources-poolside-strikes-6-billion" },
      { title: "Nvidia to Reportedly Pay $6 Billion in Licensing and Hiring Deal with AI Model Startup Poolside (The Information)", url: "https://www.theinformation.com/briefings/nvidia-reportedly-pay-6-billion-licensing-hiring-deal-ai-model-startup-poolside" },
      { title: "Nvidia in Talks With Chip Startup Rebellions for Potential Deal (Bloomberg)", url: "https://www.bloomberg.com/news/articles/2026-08-21/nvidia-in-talks-with-chip-startup-rebellions-for-potential-deal" },
      { title: "Nvidia Explores Potential Partnership Or Acquisition With Rebellions (Dataconomy)", url: "https://dataconomy.com/2026/08/21/nvidia-explores-potential-partnership-or-acquisition-with/" },
      { title: "NTT DATA and Palo Alto Networks Sign Global Strategic Alliance to Accelerate Secure AI Transformation (Palo Alto Networks)", url: "https://www.paloaltonetworks.com/company/press/2026/ntt-data-and-palo-alto-networks-sign-global-strategic-alliance-to-accelerate-secure-ai-transformation" },
      { title: "Palo Alto Networks and NTT DATA target $1B in AI security sales by 2029 (SiliconANGLE)", url: "https://siliconangle.com/2026/08/20/palo-alto-networks-and-ntt-data-target-1b-in-ai-security-sales-by-2029/" },
      { title: "日経平均終値200円安 米ウォルマート急落が消費株揺らす (日本経済新聞)", url: "https://www.nikkei.com/article/DGXZQOFL210ICTR20C26A8000000/" },
      { title: "日経平均大引け：前日比200.43円安の66016.36円 (財経新聞)", url: "https://www.zaikei.co.jp/article/20260821/866903.html" },
      { title: "三菱電機の株価反落 米社を2200億円で買収、財務負担を懸念 (日本経済新聞)", url: "https://www.nikkei.com/article/DGXZQOFL210MC0R20C26A8000000/" },
      { title: "米国PCI Energy Solutionsの完全子会社化に関するお知らせ (三菱電機/PR TIMES)", url: "https://prtimes.jp/main/html/rd/p/000000435.000120285.html" },
      { title: "CISA gives feds 3 days to fix actively exploited Ray RCE bug (The Register)", url: "https://www.theregister.com/security/2026/08/18/cisa-gives-feds-3-days-to-fix-actively-exploited-ray-rce-bug/5289007" },
      { title: "CISA Flags Actively Exploited Ray Flaw That Can Trigger Browser-Based RCE (The Hacker News)", url: "https://thehackernews.com/2026/08/cisa-flags-actively-exploited-ray-flaw.html" },
